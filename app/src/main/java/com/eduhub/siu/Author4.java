...
public class Author4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_author4, container, false);

        recyclerView=view.findViewById(R.id.list);



        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("dici");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Author4.trust_list adapter = new Author4.trust_list();
    ...
    private class trust_list extends RecyclerView.Adapter<Author4.trust_list.viewholder>{
        ...
        @NonNull
        @Override
        public Author4.trust_list.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater = getLayoutInflater();
            View view = layoutInflater.inflate(R.layout.item, parent, false);

            return new Author4.trust_list.viewholder(view);
        }


        @Override
        public void onBindViewHolder(@NonNull Author4.trust_list.viewholder holder, int position) {
