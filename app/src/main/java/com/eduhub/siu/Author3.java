...
public class Author3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_author3, container, false);
    ...
    private class trust_list extends RecyclerView.Adapter<Author3.trust_list.viewholder>{
        ...
        @NonNull
        @Override
        public Author3.trust_list.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater = getLayoutInflater();
            View view = layoutInflater.inflate(R.layout.item, parent, false);

            return new Author3.trust_list.viewholder(view);
        }


        @Override
        public void onBindViewHolder(@NonNull Author3.trust_list.viewholder holder, int position) {
