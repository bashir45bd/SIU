...
public class Librarian extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("librarian");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Librarian.list adapter = new Librarian.list();
    ...
    private class list extends RecyclerView.Adapter<Librarian.list.viewholder>{
        ...
        @NonNull
        @Override
        public Librarian.list.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater = getLayoutInflater();
            View view = layoutInflater.inflate(R.layout.item, parent, false);

            return new Librarian.list.viewholder(view);
        }


        @Override
        public void onBindViewHolder(@NonNull Librarian.list.viewholder holder, int position) {
