...
public class Treasurer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_treasurer, container, false);
        recyclerView=view.findViewById(R.id.list);
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("treasurer");
    ...
    private class list extends RecyclerView.Adapter<Treasurer.list.viewholder>{
        ...
        @NonNull
        @Override
        public Treasurer.list.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater layoutInflater = getLayoutInflater();
            View view = layoutInflater.inflate(R.layout.item, parent, false);

            return new Treasurer.list.viewholder(view);
        }


        @Override
        public void onBindViewHolder(@NonNull Treasurer.list.viewholder holder, int position) {
